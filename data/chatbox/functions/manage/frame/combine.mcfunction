...
execute if score #chatbox.icon.flag loy.value matches 1 unless data storage chatbox:main Buffer[0] unless data storage chatbox:main {CurrentText:''} run function chatbox:manage/frame/zzz/1
