data modify storage chatbox:main PreviousFormat set from storage chatbox:main InstantBuffer[0].Format
data modify storage generic:main TextInput0 set from storage chatbox:main InstantBuffer[0].Format
